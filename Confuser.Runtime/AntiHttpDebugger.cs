...
namespace Confuser.Runtime
{
	internal static class AntiHttpDebugger
	{
		...
		private static void Read()
		{
			...
			{
				MessageBox((IntPtr)0, "Http Debugger has been detected on ur computer, since it can be used for malicious ending, the program will be deleted from ur computer...", "Rzy Protector | Private version | by RZY#2000", 0);
				Closeprogram();
			}
