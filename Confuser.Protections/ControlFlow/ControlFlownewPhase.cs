...
namespace Confuser.Protections.ControlFlow {
	internal class ControlFlowNewPhase : ProtectionPhase {
	

		public ControlFlowNewPhase(ControlFlowProtection parent)
			: base(parent) { }
        ...
        public void Run(CFHelper cFHelper, MethodDef method, Blockss blocks, ConfuserContext context)
        {
