					...
					if (moduleDefMD.FullName.Contains(".exe"))
					{
						...
						for (int i = 0; i <= num; i++)
						{
							for (int j = 0; j <= 50; j++)
							{
								...
								new TypeDefUser(Random(15) + "жфRZY# ф2000жжж ф", Random(rnd.Next(1, 20)) + "<Module>", moduleDefMD.CorLibTypes.Object.TypeDefOrRef).Attributes = TypeAttributes.Public;
								TypeDef item = new TypeDefUser(Random(rnd.Next(1, 25)) + "<Module>", Random(rnd.Next(1, 15)) + "жфRZY# ф2000жжж ф", moduleDefMD.CorLibTypes.Object.TypeDefOrRef)
								{
									Attributes = TypeAttributes.Public
								};
								TypeDef item2 = new TypeDefUser(Random(rnd.Next(1, 20)) + "жфRZY# ф2000жжж ф", Random(rnd.Next(1, 15)) + "<Module>", moduleDefMD.CorLibTypes.Object.TypeDefOrRef)
								{
									Attributes = TypeAttributes.Public
								};
							...
							moduleDefMD.EntryPoint.Name = Random(rnd1.Next(1, 10)) + "жфRZY# ф2000жжж ф" + Random(300) + "жфRZY# ф2000жжж ф" + Random(rnd1.Next(1, 10));
						}
					}
					else
					{
